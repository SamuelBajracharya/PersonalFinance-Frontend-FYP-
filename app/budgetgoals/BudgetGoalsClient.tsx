                        ...
                        <>
                            <section ref={smartSuggestionsRef} className="rounded-2xl bg-secondaryBG p-4 space-y-3 mt-4">
                                ...
                                <p className="text-sm text-textsecondary">
                                    These suggestions are generated by AI using your transaction data to provide more relevant recommendations.
                                </p>
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                                ...
                                <section ref={adaptiveGoalRef} className="rounded-2xl bg-secondaryBG p-4 space-y-3">
                                    ...
                                    <p className="text-sm text-textsecondary">
                                        AI analyzes your transaction history to suggest an updated budget target and explain the recommendation.
                                    </p>
                                    {adaptive ? (
                                        <div className="space-y-1">
                                            <div className="flex justify-between border-b border-dashed border-textsecondary py-2">
