            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-2 mb-3">
              <div className="flex-1">
                ...
                <p className="text-textsecondary text-sm mt-1">
                  These recommendations are generated by an AI model using your recent transaction data — including spending categories and amounts — to provide personalized financial guidance. No raw transaction details are shared externally.
                </p>
              </div>
              <span className="inline-flex items-center gap-1.5 shrink-0 bg-primary/10 text-primary text-xs font-semibold px-3 py-1.5 rounded-full border border-primary/20 self-start">
                <svg className="size-3.5" viewBox="0 0 20 20" fill="currentColor"><path d="M10 2a8 8 0 100 16A8 8 0 0010 2zm1 11H9v-2h2v2zm0-4H9V6h2v3z"/></svg>
                AI-Powered · Uses Your Transaction Data
              </span>
            </div>
